...
把华为鸿蒙(HarmonyOS)UI 设计指南(166 篇,设计规范/视觉风格/控件设计/交互/多设备适配)封装成 MCP 检索服务,供 Claude Code / opencode / Cursor / Cline 等 AI 编程客户端在开发时调用——**做 UI 设计决策、选控件样式、定视觉规范时,先检索官方设计指南,遵循鸿蒙设计语言,不套用其他平台规范**。
